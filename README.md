...
### Sign In
![Sign In](res/signin.png)

### Dashboard
![Home Dashboard](res/home.png)

### Trip Details
![Trip Details](res/trip_details.png)

### AI Itinerary Generator
![AI Itinerary Generator](res/ai_itenary_generater.png)
![AI Itinerary](res/ai_itenary2.png)

### AI Travel Assistant
![AI Assistant](res/ai_assitant.png)
![AI Assistant Response](res/ai_assistant_response.png)

### AI Local Guide
![AI Local guide](res/ai_assistant2.png)

### VR Preview
![VR Preview - Sites](res/vr_preview_sites.png)
![VR Preview - Hotels](res/vr_preview_hotels.png)
![VR Preview - Hotel Room](res/vr_preview_hotel_1.png)

### Travel Checklist
![Travel Checklist](res/travel_checklist.png)
![Travel Checklist Details](res/travel_checklist2.png)

### Emergency SOS
![Emergency](res/emergency.png)
...
| Layer | Technology |
|-------|------------|
| **Frontend** | ![React](https://img.shields.io/badge/React_19-61DAFB?style=flat-square&logo=react&logoColor=black) ![Tailwind](https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat-square&logo=tailwind-css&logoColor=white) ![Vite](https://img.shields.io/badge/Vite_7-646CFF?style=flat-square&logo=vite&logoColor=white) |
| **Backend** | ![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=node.js&logoColor=white) ![Express](https://img.shields.io/badge/Express_5-000000?style=flat-square&logo=express&logoColor=white) ![Prisma](https://img.shields.io/badge/Prisma-2D3748?style=flat-square&logo=prisma&logoColor=white) |
| **Database** | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) ![Supabase](https://img.shields.io/badge/Supabase-3FCF8E?style=flat-square&logo=supabase&logoColor=white) ![Neon](https://img.shields.io/badge/Neon-00E699?style=flat-square&logo=neon&logoColor=black) |
| **AI/ML** | ![Google Gemini](https://img.shields.io/badge/Google_Gemini-4285F4?style=flat-square&logo=google&logoColor=white) |
| **Auth** | ![JWT](https://img.shields.io/badge/JWT-000000?style=flat-square&logo=json-web-tokens&logoColor=white) |
| **VR** | ![A-Frame](https://img.shields.io/badge/A--Frame-EF2D5E?style=flat-square&logo=aframe&logoColor=white) |
